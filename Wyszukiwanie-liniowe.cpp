 ...
 //============================================================================
  ...
  #include <iostream>
 #include <cstdlib> //biblioteka potrzebna do wywoływania funkcji odpowiedzialnych za pseudolosowosc
 #include <ctime>
 using namespace std;
  ...
  void wyswietl(int *table, int table_size) //funkcja pomocnicza do wyswietlania tablicy;
 {
  ...
  int main() {
  	...
  	srand(time(NULL)); //niezbędna do generowania przy każdym wywołaniu aplikacji różnych liczb losowych
 	int table_size = 40; //Podajemy rozmiar tablicy, która będzie przechowywać wylosowane liczby
